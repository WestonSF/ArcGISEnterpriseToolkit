#-------------------------------------------------------------
# Name:                 Create Mobile Map Package
# Purpose:              Creates a mobile map package from and an ArcGIS Pro map file (.mapx)
#                       and uploads this to a portal site.
#                       NOTE: The data included in the map package will be only data included
